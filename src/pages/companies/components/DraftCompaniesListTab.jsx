...
const DraftCompaniesListTab = ({
    ...
    const total = companyPagination?.content?.filter(company => company.status[0]?.statusCode === 'DRAFT').length;
    ...
    useEffect(() => {
        ...
        dispatch(fetchCompaniesRequest({
            status: 'DRAFT', offset: 0, limit: 100,
        }));
    }, [dispatch]);
...
export default DraftCompaniesListTab;
