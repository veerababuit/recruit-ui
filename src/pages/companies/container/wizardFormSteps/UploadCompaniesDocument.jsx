...
import { fetchDocumentRequest, fetchCompaniesDocumentRequest } from '../../../../redux/actions/adminResourceRoleAction';
...
import UploadedCompaniesDocuments from './UploadedCompaniesDocuments';
import { storeDocumentData } from '../../../../redux/actions/companiesActions';

function UploadCompaniesDocument({
    control,
    errors,
    validationErrors,
    handleOnHide,
    ...
    const dataApi = useSelector((state) => state.adminRole.companiesDocumentsList);
    const dataById = useSelector((state) => state.adminRole.selectedDocumentData);
    const currentOrganizationID = useSelector((state) => state.company.organizationID);
    const selectedDocuments = useSelector((state) => state.company.selectedDocuments);
    ...
    const handleUpload = async () => {
        ...
        const apiUrl = `http://20.42.92.222/recruit-0.0.1-SNAPSHOT/api/raves/v1/organization/${organizationID}/documentfile`;
        ...
        <>
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly title="Upload Companies Supporting Documents" onClick={handleCancel} />
                </div>
                <div className="flex-wrap fixed p-fluid overflow-y-auto w-75 p-3 right-0 event-body">
                    {/* <UploadedMsaDocument */}
                    <UploadedCompaniesDocuments
            ...
            <div className="p-1 flex justify-content-between align-items-center border-bottom-1">
                <h4 className="fw-bold text-center "> Companies Supporting Documents</h4>
            </div>
...
export default UploadCompaniesDocument;