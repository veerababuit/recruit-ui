...
import WORateBillRateStep from "../container/wizardFormSteps/WO/WORateBillRateStep";
...
const addContractWOSteps = [
    {
        name: 'WO Rate (Bill Rate)',
        component: WORateBillRateStep,
        nextStep : 'Work Order'
    },
    {
...
export default addContractWOSteps