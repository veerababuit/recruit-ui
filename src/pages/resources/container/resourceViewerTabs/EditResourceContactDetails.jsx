...
function EditResourceContactDetails({ active, setActive }) {
    ...
    const handleEdit = () => {
        setIsEdit(true);
        setActive('editResourceContactDetails');
    };
                ...
                <>
                    <div className="formgrid grid m-2">
                        <div className="col-12 md:col-6">
                            ...
                            <p className="p-text-primary">{selectedResource?.personLegal?.primaryContactDetails[0]?.phoneNumber.dialNumber || '--'}</p>
                        </div>
                        <div className="col-12 md:col-6">
                            <label className='p-text-secondary'>Email</label>
                            {/* <p className="p-text-primary">{selectedResource?.personLegal?.primaryContactDetails?.emailId || '--'}</p> */}
                        </div>
                    </div>
                </>
            )}
...
export default EditResourceContactDetails;
