...
function Deductions() {
    ...
    const addDeductionActionHandler = () => {
        setSidebarVisible(true);
    };

    const closeDeductionActionHandler = () => {
    ...
    return (
        ...
        <div className='mt-4'>
            ...
            <Viewer
                ...
                contentComponent={<AddDeductions />}
            />
            <Toast ref={toast} />
            <div>
                {/* accounts */}
                ...
                <div className="company-main-text fs-6 pb-2 mt-2 fw-bold d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <Button
                            ...
                            severity="primary"
                            icon="pi pi-plus"
                            onClick={addDeductionActionHandler}
                            size="small"
                        />
                    </div>
                </div>
                ...
                <div className="rounded border p-2">
                    <div className="formgrid grid mt-2 mb-2">
                        ...
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Deduction 1</label>
                            <p className="p-text-primary">{"Medical"}</p>
                        </div>
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Type</label>
                            <p className="p-text-primary">{"Dollor"}</p>
                        </div>
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Doller</label>
                            <p className="p-text-primary">{"$ 20"}</p>
                        </div>
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Does this deduction have a goal amount?</label>
                            <p className="p-text-primary">{"No"}</p>
                        </div>
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Payement method for this deduction</label>
                ...
                <div className="rounded border mt-4 p-2">
                    <div className="formgrid grid mt-2 mb-2">
                        ...
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Deduction 2</label>
                            <p className="p-text-primary">{"Advance"}</p>
                        </div>
                        <div className="col-12 md:col-4 ">
                            <label className='p-text-secondary'>Type</label>
                            <p className="p-text-primary">{"Dollor"}</p>
