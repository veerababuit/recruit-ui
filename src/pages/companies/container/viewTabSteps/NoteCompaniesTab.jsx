    ...
    <>
      <div className='p-2'>
        <div className="d-flex justify-content-end align-items-center mt-2">
          <Button label="" severity="primary" icon="pi pi-plus fs-5" size="small" onClick={handleAdd} />
        </div>
        <InputTextarea
          autoResize
          value={textareaValue}
      ...
      <div className="profile_card m-1 d-flex justify-content-start align-items-center gap-1 p-2  ">
        ...
        <div>
          <span className="p-0 mb-0 company-main-text fs-6 fw-bold">Mukesh Koneru</span>{' '}
          <span className="company-secondary-text">Jun-25 2023at 17.13</span>
...
export default NoteCompaniesTab;
