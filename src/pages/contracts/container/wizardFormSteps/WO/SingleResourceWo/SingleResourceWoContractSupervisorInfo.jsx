...
function SingleResourceWoContractSupervisorInfo({ control, errors }) {
    let required = false
    return (
        <>
            <div className=" flex-wrap gap-3 p-fluid">
            <h4 className="fw-bold text-center" >Supervisor Info (Client)</h4>
...
export default SingleResourceWoContractSupervisorInfo;