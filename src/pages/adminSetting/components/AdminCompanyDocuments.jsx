...
function AdminContract() {
    ...
    const handleUpdate = () => {
        ...
        dispatch(updateCompanyDocumentRequest(id, editPayload));
        reset();
        toggleSidebar();
        showInfo();
    };
        ...
        <>
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly
                        title={showEditForm ? 'Edit Companies Definitions ' : 'Companies Definitions'}
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly title="Create Companies Document Definition" onClick={handleCancel} />
                </div>
