...
const CreateInvoiceStep = ({ handleScroll }) => {
    ...
    return (
        <>
            {isInvoiceCreated ? (
                ...
                <div
                    className="fixed right-0 w-75 viewer-with-footer-body overflow-y-auto px-2"
                ...
                >
                    ...
                    <div class="formgrid grid mb-6 m-2">
                        ...
                        <div className="p-sidebar-header h-custom-10 col-12 d-flex justify-content-end fixed bottom-0 right-0 w-75 footer-bg p-3 gap-3">
                            <Button
                                type="button"
                                severity="secondary"
                                icon=""
