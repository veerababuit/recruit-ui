...
import AdminContractCycle from '../container/AdminContracts/AdminContractCycle';
...
function AdminContract() {
    ...
    const handleUpdate = () => {
        ...
        dispatch(updateContractDocumentRequest(id, editPayload));
        reset();
        toggleSidebar();
        showInfo();
    };
        ...
        <>
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly
                        title={showEditForm ? 'Edit Contract Definitions ' : 'Contract Definitions'}
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly title="Create Contract Document Definition" onClick={handleCancel} />
                </div>
            ...
            <div className="flex justify-content-between align-items-center border-bottom p-1">
                <div className="fs-4 fw-bold">Contract Documents</div>
