...
function WorkPermit({setActive}) {
    ...
    const onSubmit = (data) => {
        ...
        toast.current.show({
            ...
            detail: 'Work Permit updated successfully!',
          });
    };
        ...
        <div className='rounded border p-2'>
            ...
            <div className="formgrid grid m-2">
             <div className="col-12 md:col-3 mb-2">
                 <label className='p-text-secondary'>Work Permit</label>
                 <p className="p-text-primary">{"---"}</p>
             </div>
             <div className="col-12 md:col-3  mb-2">
                 <label className='p-text-secondary'>Document ID</label>
                 <p className="p-text-primary">{"---"}</p>
             </div>
             <div className="col-12 md:col-4  mb-2">
                 <div className='formgroup-inline'>
                     <div className='field-checkbox'>
                         <input type='checkbox' id="workPermit" className='cursor-pointer  custom-checkbox'

                             // checked={isCheckboxChecked}
                             readOnly
                         />
                         <label for="workPermit" className='fw-bold cursor-pointer'> Remind me 6 months before expiration </label>
                     </div>
                 </div>
             </div>
          ...
          <Viewer
            ...
            header={
                ...
                title={"Edit Work Permit Details" }
                />
            }
            contentComponent={
                ...
                <div className="formgrid grid p-3">
                    <div className="col-12 md:col-6">
                        <CustomInputText
                            ...
                            autoFocus
                            required={required}
                            requiredMsg="Work Permit is required"
