...
import AdminDocumentTable from '../container/AdminDocuments/AdminDocumentTable';
import AdminDocumentDetails from '../container/AdminDocuments/AdminDocumentDetails';
...
function AdminContract() {
    ...
    const onSubmit = (data) => {
        ...
        dispatch(createDocumentData(apiPayLoad));
        reset();
        ...
        <>
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly
                        title={showEditForm ? 'Edit Resource Definitions ' : 'Resource Definitions'}
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly title="Create Resource Document Definition" onClick={handleCancel} />
                </div>
